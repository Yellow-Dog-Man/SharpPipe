...
//     public static unsafe extern int sp_zitarev_create(ref sp_zitarev* zitaRevObject);
...
//     /// <returns>Success code</returns>
//     [DllImport("libsoundpipe")]
//     public static unsafe extern int sp_zitarev_init(sp_data* spObject, sp_zitarev* zitaRevObject);
...
//     /// <returns>Success code</returns>
//     [DllImport("libsoundpipe")]
//     public static unsafe extern int sp_zitarev_compute(sp_data* spObject, sp_zitarev* zitaRevObject, ref float in1, ref float in2, [In, Out] ref float out1, [In, Out] ref float out2);
...
//     /// <returns>Success code</returns>
//     [DllImport("libsoundpipe")]
//     public static unsafe extern int sp_zitarev_destroy(ref sp_zitarev* zitaRevObject);
...
//     /// <returns>Success code</returns>
//     [DllImport("libsoundpipe")]
//     public static unsafe extern int sp_zitarev_compute_many(sp_data* spObject, sp_zitarev* zitaRevObject, int count, ref IntPtr inputs, ref IntPtr outputs);
// }
